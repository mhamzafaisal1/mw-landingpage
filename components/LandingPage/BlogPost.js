    ...
    <>
      <div className="blog-area pt-75 pb-75">
        <div className="container">
          <div className="section-title blogTitle">
            <h2>Insights & Inspirations, Trends & Innovations</h2>
            <span className="sub-title">
              Stay informed and inspired with our latest blog articles on
              digital marketing trends, tips, and success stories.
            </span>
          </div>
